...
public class ProtocolMessage {
	...
	/**
	 * Crea una trama de tipo consumo a partir de los datos pasados por parámetros.
	...
	/**
	 * Crea una trama de tipo evento a partir de los datos pasados por parámetros.
	 * @return the mNumSerie
	 */
	public static String crearTrama(String numSerie, Vector<Long> tiempos,
			 				 Vector<Integer> potenciasApar, Vector<Integer> potenciasAct,
	...
	/**
	 * Crea una trama de tipo estado a partir de los datos pasados por parámetros.
	 * @return the mNumSerie
	 */
	public static String crearTrama(String numSerie, Vector<Long> tiempos,
